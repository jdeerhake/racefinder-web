...
MarkerStyles.ACTIVE_ICON = _.extend({}, icon, {
  fillColor: styles.color.active
})

MarkerStyles.HIGHLIGHTED_ICON = _.extend({}, icon, {
  fillColor: styles.color.link
})

MarkerStyles.INACTIVE_ICON = _.extend({}, icon, {
  fillColor: styles.color.stylized
})
